...
class TaskTableModel(QAbstractTableModel):
    ...
    # Parameter types are the UNION the PySide6 stubs declare (QModelIndex |
    # QPersistentModelIndex). Narrowing them to plain QModelIndex would violate
    # override contravariance and strict mypy rejects it against the real stubs
    # (verified installed at /usr/lib/python3.14/site-packages/PySide6/*.pyi).
