...
## Status (updated 2026-06-11, Task 6 approved)
Phase: Executing (subagent-driven), Tasks 1-6 of 9 complete
Done: T1-T5 (see git log; DEF-T2-01, DEF-T4-01, DEF-A-01 open); T6 model (4724b89+6f1abd1: review found display-string sorting broke the spec's sort promise → ROLE_SORT raw-epoch keys; activating-as-running for oneshot jobs, probed; bounds check; 10 model tests). Suite: 48 tests. Task 7 handoff checklist (4 items now) lives above the Task 8 heading.
Next: Task 7 (MainWindow + offscreen smoke test)
Blocked: nothing
