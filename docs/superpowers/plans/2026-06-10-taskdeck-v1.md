...
## Status (updated 2026-06-11, Task 4 approved after review fixes)
Phase: Executing (subagent-driven), Tasks 1-4 of 9 complete
Done: T1 scaffold; T2 parsers+fixtures (DEF-T2-01); T3 time rendering; T4 SystemdClient (233199c+cf8c290+c323ce8: echo-identity guards, crash-vs-exit stderr, calendar --, spawn test resolves DEF-A-02; QProcess leak deferred as DEF-T4-01 — both standard fixes segfault PySide6 6.11/py3.14, probed twice). Suite: 30 tests. Task 7 handoff notes live above the Task 8 heading.
Next: Task 5 (actions.py argv builder + scope guard)
Blocked: nothing
